...
const libraryItems = [
    ...
    { id: 'webhook-forwarder', name: 'Webhook Forwarder', description: 'Inbound webhook → outbound webhook. Decompose the event, build a payload via data.template, POST it onward.', category: 'productivity', icon: '🪝', tags: ['webhook', 'forwarder', 'utility.webhook'], template: 'webhook-forwarder', requiredIntegrations: [], difficulty: 'medium', status: 'available', popular: false, defaultTrigger: { source: ['webhook'], event: ['incoming'] } },
    { id: 'event-debug-tap', name: 'Event Debug Tap', description: 'Wires data.event-fields → utility.log to dump every incoming event\'s source/name/payload to the log.', category: 'diagnostics', icon: '🩺', tags: ['debug', 'data.event-fields', 'tap'], template: 'event-debug-tap', requiredIntegrations: ['github'], difficulty: 'easy', status: 'available', popular: false, defaultTrigger: { source: ['github'], event: [''] } },
